...
remo_obj <- AddMetaData(remo_obj, obj$predicted.annotation.l1, col.name = "multiome_annotation")
...
remo_obj$prediction_score <- obj$predicted.annotation.l1.score
...
# organ specific
cl <- REMO.v1.GRCh38.tissues$Pancreas
