# lung
# get files from S3
aws s3 cp s3://stuartlab/ENCODE/lung/atac_fragments.tsv.gz ./
aws s3 cp s3://stuartlab/ENCODE/lung/atac_fragments.tsv.gz.tbi ./
aws s3 cp s3://stuartlab/ENCODE/lung/filtered_feature_bc_matrix.h5 ./
